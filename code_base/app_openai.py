...
Streamlit + ChromaDB (local vectors) + OpenAI API (LLM)
"""
...
def call_openai(system_prompt: str, user_prompt: str, model: str = OPENAI_MODEL) -> str:
    ...
    try:
        ...
        return f"❗ Unable to call OpenAI API: {e}\nTraceback:\n{tb}"
...
- Works fully online with OpenAI API — make sure your OPENAI_API_KEY is set in environment variables.
"""
)
